...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed top-0 left-0 z-50 h-full bg-surface-card border-r border-surface-border transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0',
