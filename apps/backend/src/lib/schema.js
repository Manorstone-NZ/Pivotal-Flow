...
export const resourceAllocations = pgTable('resource_allocations', {
    ...
    userDateOverlap: uniqueIndex('resource_allocations_user_date_overlap').on(table.userId, table.startDate, table.endDate),
    // Index for efficient project queries
    projectUser: uniqueIndex('resource_allocations_project_user').on(table.projectId, table.userId, table.startDate),
    // Index for capacity calculations
    userDateRange: uniqueIndex('resource_allocations_user_date_range').on(table.userId, table.startDate, table.endDate),
}));
