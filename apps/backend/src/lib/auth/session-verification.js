...
export async function verifySession(request, reply) {
    try {
        ...
        request.tenantId = sessionData.tenantId;
...
export async function verifyPaseto(request, reply) {
    try {
...
export async function verifyPublicPaseto(request, reply) {
    try {
...
async function setTenantContext(_request, tenantId) {
    try {
...
export async function registerSessionVerification(fastify) {
...
//# sourceMappingURL=session-verification.js.map