 ...
 */
export function getDbColumnName(table, field) {
    const tableMapping = columnMapping[table];
    if (!tableMapping) {
        throw new Error(`Unknown table: ${table}`);
    }
    const columnName = tableMapping[field];
    if (!columnName) {
 ...
 */
export function getAppFieldName(table, column) {
    const tableMapping = columnMapping[table];
    if (!tableMapping) {
        throw new Error(`Unknown table: ${table}`);
    }
 ...
 */
export function isSnakeCaseTable(table) {
 ...
 */
export function isCamelCaseTable(table) {
