...
export declare const ROUTE_PERMISSIONS: {
    ...
    readonly 'GET /customers': "Manage Customers";
    readonly 'POST /customers': "Manage Customers";
    readonly 'GET /customers/:id': "Manage Customers";
    readonly 'PATCH /customers/:id': "Manage Customers";
    readonly 'DELETE /customers/:id': "Manage Customers";
    readonly 'GET /customers/:id/contacts': "Manage Customers";
    readonly 'POST /customers/:id/contacts': "Manage Customers";
    readonly 'GET /customers/:id/contacts/:contactId': "Manage Customers";
    readonly 'PATCH /customers/:id/contacts/:contactId': "Manage Customers";
    readonly 'DELETE /customers/:id/contacts/:contactId': "Manage Customers";
    readonly 'GET /organizations': "Super Admin Access";
    readonly 'POST /organizations': "Manage Organizations";
    readonly 'GET /organizations/:id': "Super Admin Access";
    readonly 'PATCH /organizations/:id': "Manage Organizations";
    readonly 'DELETE /organizations/:id': "Manage Organizations";
    ...
    readonly 'GET /v1/admin/tenants': "system.super_admin";
    readonly 'POST /v1/admin/tenants': "system.super_admin";
    readonly 'GET /v1/admin/tenants/:id': "system.super_admin";
    readonly 'PATCH /v1/admin/tenants/:id': "system.super_admin";
    readonly 'POST /v1/admin/tenants/:id/users': "system.super_admin";
    readonly 'DELETE /v1/admin/tenants/:id/users/:membershipId': "system.super_admin";
};
