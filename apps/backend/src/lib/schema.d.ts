...
export declare const tenantFeatures: import("drizzle-orm/pg-core").PgTableWithColumns<{
...
export declare const users: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        passwordHashAlgo: import("drizzle-orm/pg-core").PgColumn<{
        ...
        passwordHashSalt: import("drizzle-orm/pg-core").PgColumn<{
...
export declare const f2RateCards: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "f2_rate_cards";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "f2_rate_cards";
            dataType: "string";
            columnType: "PgText";
            data: string;
            driverParam: string;
...
export declare const f2Services: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "f2_services";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "f2_services";
            dataType: "string";
            columnType: "PgText";
            data: string;
            driverParam: string;
...
export declare const quotes: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        tokenUsedAt: import("drizzle-orm/pg-core").PgColumn<{
            name: "token_used_at";
            tableName: "quotes";
            dataType: "date";
            columnType: "PgTimestamp";
...
export declare const timeEntries: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        billableAmount: import("drizzle-orm/pg-core").PgColumn<{
...
export declare const timeEntryApprovals: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "time_entry_approvals";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "time_entry_approvals";
            dataType: "string";
            columnType: "PgText";
            data: string;
            driverParam: string;
...
export declare const usersRelations: import("drizzle-orm").Relations<"users", {
    ...
    approvedTimeEntries: import("drizzle-orm").Many<"time_entries">;
    rejectedTimeEntries: import("drizzle-orm").Many<"time_entries">;
    timeEntryApprovals: import("drizzle-orm").Many<"time_entry_approvals">;
}>;
...
export declare const customersRelations: import("drizzle-orm").Relations<"customers", {
    organization: import("drizzle-orm").One<"organizations", true>;
    contacts: import("drizzle-orm").Many<"customer_contacts">;
    quotes: import("drizzle-orm").Many<"quotes">;
    portalUsers: import("drizzle-orm").Many<"users">;
}>;
export declare const customerContactsRelations: import("drizzle-orm").Relations<"customer_contacts", {
...
export declare const f2RateCardsRelations: import("drizzle-orm").Relations<"f2_rate_cards", {
    organization: import("drizzle-orm").One<"organizations", true>;
    tenant: import("drizzle-orm").One<"tenants", false>;
    services: import("drizzle-orm").Many<"f2_services">;
}>;
export declare const f2ServicesRelations: import("drizzle-orm").Relations<"f2_services", {
    rateCard: import("drizzle-orm").One<"f2_rate_cards", true>;
}>;
...
export declare const timeEntriesRelations: import("drizzle-orm").Relations<"time_entries", {
    ...
    project: import("drizzle-orm").One<"projects", false>;
    approvedBy: import("drizzle-orm").One<"users", false>;
    rejectedBy: import("drizzle-orm").One<"users", false>;
    invoice: import("drizzle-orm").One<"invoices", false>;
    currency: import("drizzle-orm").One<"currencies", true>;
    approvals: import("drizzle-orm").Many<"time_entry_approvals">;
}>;
export declare const timeEntryApprovalsRelations: import("drizzle-orm").Relations<"time_entry_approvals", {
    timeEntry: import("drizzle-orm").One<"time_entries", true>;
    approver: import("drizzle-orm").One<"users", true>;
}>;
...
export declare const publicRateLimits: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "public_rate_limits";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "public_rate_limits";
            dataType: "string";
            columnType: "PgText";
            data: string;
            driverParam: string;
...
export declare const publicTokenAudit: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "public_token_audit";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "public_token_audit";
            dataType: "string";
            columnType: "PgText";
            data: string;
            driverParam: string;
...
export declare const sessions: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        refreshKid: import("drizzle-orm/pg-core").PgColumn<{
            name: "refresh_kid";
            tableName: "sessions";
            dataType: "string";
            columnType: "PgText";
...
export declare const oprfRecords: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "oprf_records";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "oprf_records";
            dataType: "string";
            columnType: "PgText";
            data: string;
            driverParam: string;
...
export declare const pasetoKeys: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "paseto_keys";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "paseto_keys";
            dataType: "string";
            columnType: "PgText";
            data: string;
            driverParam: string;
...
export declare const authAudit: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "auth_audit";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
