    ...
    describe('End-to-End Allocation Workflow', () => {
        it('should handle complete allocation lifecycle', async () => {
            ...
            try {
                ...
                const updatedAllocation = await allocationService.updateAllocation(createdAllocation.id, updateData);
                ...
                const allocationsList = await allocationService.getAllocations({
                    ...(testProject[0]?.id && { projectId: testProject[0].id }),
                    role: ALLOCATION_ROLES.ARCHITECT
                });
        ...
        it('should calculate project capacity correctly', async () => {
            ...
            try {
                ...
                const totalPlannedPercent = capacity.allocations.reduce((sum, alloc) => sum + alloc.plannedPercent, 0);
    ...
    describe('Performance Tests', () => {
        it('should handle conflict checks within performance threshold', async () => {
            ...
            try {
                ...
                const conflicts = await allocationService['checkAllocationConflicts'](testUser.id, '2025-01-15', '2025-12-15', 50);
