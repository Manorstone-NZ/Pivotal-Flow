...
describe('AllocationService', () => {
    ...
    describe('Allocation Updates', () => {
        ...
        it('should successfully update allocation with valid data', async () => {
            ...
            const updatedAllocation = await allocationService.updateAllocation(existingAllocation[0].id, updateData);
    ...
    describe('Conflict Detection', () => {
        it('should detect overlapping date ranges', async () => {
            ...
            const conflicts = await allocationService['checkAllocationConflicts'](testUser.id, '2025-01-15', '2025-02-15', 50);
        ...
        it('should not detect conflicts for non-overlapping dates', async () => {
            ...
            const conflicts = await allocationService['checkAllocationConflicts'](testUser.id, '2025-02-01', '2025-02-28', 90);
