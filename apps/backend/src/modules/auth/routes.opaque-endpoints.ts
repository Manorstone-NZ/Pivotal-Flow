...
export const opaqueAuthRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  }, async (request: FastifyRequest<{ Body: typeof OpaqueRegistrationStartSchema.static }>, reply: FastifyReply) => {
    try {
  ...
  }, async (request: FastifyRequest<{ Body: typeof OpaqueRegistrationFinishSchema.static }>, reply: FastifyReply) => {
    try {
  ...
  }, async (request: FastifyRequest<{ Body: typeof OpaqueLoginStartSchema.static }>, reply: FastifyReply) => {
    try {
  ...
  }, async (request: FastifyRequest<{ Body: typeof OpaqueLoginFinishSchema.static }>, reply: FastifyReply) => {
    try {
  ...
  fastify.post('/auth/password/upgrade', {
    ...
    try {
      ...
      const verification = await argon2PasswordService.verifyPassword(
        request.body.currentPassword,
        userData.passwordHash || '',
        userData.passwordHashSalt,
        userData.passwordHashAlgo
      );
