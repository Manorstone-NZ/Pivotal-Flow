...
export const refreshRoute = async (fastify) => {
    ...
    fastify.post('/refresh', {
        ...
        try {
            ...
            const newRefreshToken = await fastify.tokenManager.signRefreshToken({
                sub: decoded.sub,
                org: decoded.org,
                roles: decoded.roles ?? [],
            });
            ...
            try {
                await auditLogger.logAuthEvent('auth.refresh', decoded.org, decoded.sub, {}, request);
            }
            catch (auditError) {
...
//# sourceMappingURL=routes.refresh.js.map