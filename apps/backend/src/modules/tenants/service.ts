...
export class TenantService {
   ...
   * Create new tenant
   */
  async createTenant(data: Static<typeof CreateTenantSchema>, creatorUserId?: string) {
   ...
   * Update tenant
   */
  async updateTenant(tenantId: string, data: Static<typeof UpdateTenantSchema>) {
    const now = new Date();
   ...
   */
  async listMemberships(tenantId: string, options: {
    page?: number;
    limit?: number;
    includeUser?: boolean;
  } = {}) {
   ...
   * Create membership
   */
  async createMembership(tenantId: string, data: Static<typeof CreateMembershipSchema>) {
   ...
   */
  async updateMembership(userId: string, tenantId: string, data: Static<typeof UpdateMembershipSchema>) {
    const now = new Date();
   ...
   * Delete membership
   */
  async deleteMembership(userId: string, tenantId: string) {
   ...
   */
  async updateTenantFeatures(tenantId: string, data: Static<typeof UpdateTenantFeaturesSchema>) {
    const now = new Date();
    const results = [];
