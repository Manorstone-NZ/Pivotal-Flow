...
export const CreateApprovalRequestSchema = z.object({
    entityType: z.enum(Object.values(APPROVAL_ENTITY_TYPES)),
...
export const ApprovalFiltersSchema = z.object({
    entityType: z.enum(Object.values(APPROVAL_ENTITY_TYPES)).optional(),
...
export const ApprovalRequestResponseSchema = z.object({
    ...
    approverId: z.string(),
    status: z.enum(Object.values(APPROVAL_STATUS)),
...
export const createApprovalsPagingResponse = (approvals, page, pageSize, total) => {
