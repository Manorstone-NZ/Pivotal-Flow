...
export async function rateCardRoutes(fastify) {
    ...
    fastify.get('/rate-cards/:id', {
        ...
        try {
            ...
            fastify.log.error(error, 'Error getting rate card');
            reply.status(500).send({
                error: 'Internal server error',
                message: error instanceof Error ? error.message : 'Unknown error'
            });
    ...
    fastify.get('/rate-cards', {
        ...
        try {
            ...
            fastify.log.error(error, 'Error listing rate cards');
            reply.status(500).send({
                error: 'Internal server error',
                message: error instanceof Error ? error.message : 'Unknown error'
            });
    ...
    fastify.put('/rate-cards/:id', {
        ...
        try {
            ...
            fastify.log.error(error, 'Error updating rate card');
            reply.status(500).send({
                error: 'Internal server error',
                message: error instanceof Error ? error.message : 'Unknown error'
            });
    ...
    fastify.post('/rate-cards/:id/items', {
        ...
        try {
            ...
            fastify.log.error(error, 'Error creating rate card item');
            reply.status(500).send({
                error: 'Internal server error',
                message: error instanceof Error ? error.message : 'Unknown error'
            });
    ...
    fastify.put('/rate-cards/:id/items/:itemId', {
        ...
        try {
            ...
            const result = await rateCardService.updateRateCardItem(itemId, validatedData);
            if (!result) {
                return reply.status(404).send({
                    error: 'Not found',
            ...
            fastify.log.error(error, 'Error updating rate card item');
            reply.status(500).send({
                error: 'Internal server error',
                message: error instanceof Error ? error.message : 'Unknown error'
            });
    ...
    fastify.post('/rate-cards/resolve-pricing', {
        ...
        try {
            ...
            fastify.log.error(error, 'Error resolving pricing');
            reply.status(500).send({
                error: 'Internal server error',
                message: error instanceof Error ? error.message : 'Unknown error'
            });
    ...
    fastify.get('/rate-cards/active/:date', {
        ...
        try {
            ...
            fastify.log.error(error, 'Error getting active rate card');
            reply.status(500).send({
                error: 'Internal server error',
                message: error instanceof Error ? error.message : 'Unknown error'
            });
