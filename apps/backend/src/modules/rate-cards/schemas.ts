...
export function validateRateCardData(data: z.infer<typeof CreateRateCardSchema>) {
...
export function validateRateCardItemData(data: z.infer<typeof CreateRateCardItemSchema>) {
