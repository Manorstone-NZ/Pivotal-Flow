...
export declare const CreateRateCardItemSchema: import("@sinclair/typebox").TObject<{
    ...
    roleId: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString, import("@sinclair/typebox").TNull]>>;
    ...
    baseRate: import("@sinclair/typebox").TString;
    currency: import("@sinclair/typebox").TString;
    taxClass: import("@sinclair/typebox").TString;
    tieringModelId: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString, import("@sinclair/typebox").TNull]>>;
    effectiveFrom: import("@sinclair/typebox").TString;
    effectiveUntil: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString, import("@sinclair/typebox").TNull]>>;
    isActive: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TBoolean>;
    metadata: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TRecord<import("@sinclair/typebox").TString, import("@sinclair/typebox").TUnknown>>;
}>;
...
export declare const UpdateRateCardItemSchema: import("@sinclair/typebox").TObject<{
    ...
    baseRate: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString>;
    currency: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString>;
...
export declare const RateCardResponseSchema: import("@sinclair/typebox").TObject<{
    ...
    currency: import("@sinclair/typebox").TString;
    effectiveFrom: import("@sinclair/typebox").TString;
    effectiveUntil: import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString, import("@sinclair/typebox").TNull]>;
    isDefault: import("@sinclair/typebox").TBoolean;
    isActive: import("@sinclair/typebox").TBoolean;
    metadata: import("@sinclair/typebox").TRecord<import("@sinclair/typebox").TString, import("@sinclair/typebox").TUnknown>;
...
export declare const RateCardItemResponseSchema: import("@sinclair/typebox").TObject<{
    ...
    serviceCategoryId: import("@sinclair/typebox").TString;
    roleId: import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString, import("@sinclair/typebox").TNull]>;
    itemCode: import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString, import("@sinclair/typebox").TNull]>;
    unit: import("@sinclair/typebox").TString;
    baseRate: import("@sinclair/typebox").TString;
    currency: import("@sinclair/typebox").TString;
    taxClass: import("@sinclair/typebox").TString;
    tieringModelId: import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString, import("@sinclair/typebox").TNull]>;
    effectiveFrom: import("@sinclair/typebox").TString;
    effectiveUntil: import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString, import("@sinclair/typebox").TNull]>;
    isActive: import("@sinclair/typebox").TBoolean;
    metadata: import("@sinclair/typebox").TRecord<import("@sinclair/typebox").TString, import("@sinclair/typebox").TUnknown>;
