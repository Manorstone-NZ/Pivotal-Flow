...
describe('ReportingService', () => {
  ...
  describe('generateTimeApprovalsSummary', () => {
    it('should generate placeholder summary', async () => {
      const filters: TimeApprovalsFilters = {
        organizationId: 'test-org-id',
      };
  ...
  describe('calculateMedian', () => {
    it('should calculate median for odd number of values', () => {
      ...
      const median = (reportingService as any).calculateMedian(values);
  ...
  describe('groupBy', () => {
    it('should group items by property', () => {
      ...
      const result = (reportingService as any).groupBy(items, 'status');
  ...
  describe('calculateDistribution', () => {
    it('should calculate distribution correctly', () => {
      ...
      const result = (reportingService as any).calculateDistribution(values, ranges);
