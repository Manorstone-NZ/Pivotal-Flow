...
export async function currencyRoutes(fastify) {
    ...
    fastify.get('/currencies', {
        ...
        try {
            ...
            fastify.log.error(error, 'Error fetching currencies');
    ...
    fastify.get('/currencies/popular', {
        ...
        try {
            ...
            fastify.log.error(error, 'Error fetching popular currencies');
    ...
    fastify.get('/currencies/region/:region', {
        ...
        try {
            ...
            fastify.log.error(error, 'Error fetching currencies by region');
    ...
    fastify.get('/currencies/:code', {
        ...
        try {
            ...
            fastify.log.error(error, 'Error fetching currency');
    ...
    fastify.get('/currencies/:code/validate', {
        ...
        try {
            ...
            fastify.log.error(error, 'Error validating currency');
    ...
    fastify.post('/currencies/format', {
        ...
        try {
            ...
            fastify.log.error(error, 'Error formatting currency');
