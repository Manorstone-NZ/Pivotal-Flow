...
const DecimalSchema = z.custom((val) => val instanceof Decimal, {
...
export const QuoteLineItemSchema = z.object({
    ...
    type: z.enum(Object.values(LineItemType)).default(LineItemType.SERVICE),
...
export const CreateQuoteSchema = z.object({
    ...
    type: z.enum(Object.values(QuoteType)).default(QuoteType.PROJECT),
...
export const UpdateQuoteSchema = z.object({
    ...
    description: z.string().max(2000).optional(),
    type: z.enum(Object.values(QuoteType)).optional(),
...
export const QuoteStatusTransitionSchema = z.object({
    status: z.enum(Object.values(QuoteStatus)),
    notes: z.string().max(2000).optional()
});
// Quote list filters schema
export const QuoteListFiltersSchema = z.object({
    status: z.enum(Object.values(QuoteStatus)).optional(),
...
export const QuoteResponseSchema = z.object({
    ...
    status: z.enum(Object.values(QuoteStatus)),
    type: z.enum(Object.values(QuoteType)),
    validFrom: z.string().datetime(),
    validUntil: z.string().datetime(),
    currency: z.string(),
    ...
    lineItems: z.array(z.object({
        id: z.string().uuid(),
        lineNumber: z.number(),
        type: z.enum(Object.values(LineItemType)),
