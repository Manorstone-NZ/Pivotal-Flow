...
describe('IdempotencyService', () => {
  ...
  beforeEach(() => {
    idempotencyService = new IdempotencyService(mockDb as any);
    vi.clearAllMocks();
  });
...
describe('QuoteVersioningService', () => {
  let versioningService: QuoteVersioningService;

  beforeEach(() => {
    versioningService = new QuoteVersioningService(mockDb as any);
    vi.clearAllMocks();
  });
...
describe('QuoteLockingService', () => {
  let lockingService: QuoteLockingService;

  beforeEach(() => {
    lockingService = new QuoteLockingService(mockDb as any);
    vi.clearAllMocks();
  });
