...
import {
  ...
  PortalTimeEntryFiltersSchema,
  PortalQuoteQuerySchema,
  PortalInvoiceQuerySchema,
  PortalTimeEntryQuerySchema,
  PortalQuoteListResponseSchema,
  PortalQuoteDetailSchema,
  PortalInvoiceListResponseSchema,
...
export async function portalRoutes(fastify: FastifyInstance) {
  ...
  await fastify.register(async function portalScope(fastify) {
    ...
    fastify.get('/v1/portal/quotes', {
      ...
      const portalRequest = request as any as PortalRequest;
      try {
