 ...
 */
import { z } from 'zod';
import { CUSTOMER_VISIBLE_QUOTE_STATUSES, CUSTOMER_VISIBLE_INVOICE_STATUSES, PORTAL_CONFIG } from './constants.js';
...
const BasePortalQuoteFiltersSchema = z.object({
    status: z.union([
        z.enum(Object.values(CUSTOMER_VISIBLE_QUOTE_STATUSES)),
        z.array(z.enum(Object.values(CUSTOMER_VISIBLE_QUOTE_STATUSES)))
    ]).optional(),
...
const BasePortalInvoiceFiltersSchema = z.object({
    status: z.union([
        z.enum(Object.values(CUSTOMER_VISIBLE_INVOICE_STATUSES)),
        z.array(z.enum(Object.values(CUSTOMER_VISIBLE_INVOICE_STATUSES)))
    ]).optional(),
    fromDate: ISODateString.optional(),
    toDate: ISODateString.optional()
});
...
export const PortalQuoteSchema = z.object({
    ...
    status: z.enum(Object.values(CUSTOMER_VISIBLE_QUOTE_STATUSES)),
    type: z.string(),
...
export const PortalInvoiceSchema = z.object({
    ...
    title: z.string(),
    description: z.string().nullable(),
    status: z.enum(Object.values(CUSTOMER_VISIBLE_INVOICE_STATUSES)),
    currency: z.string().length(3),
    subtotal: z.string(),
    taxAmount: z.string(),
    discountAmount: z.string(),
