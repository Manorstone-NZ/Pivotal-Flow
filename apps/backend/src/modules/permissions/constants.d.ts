...
export declare const ALL_PERMISSIONS: ("reports.view_reports" | "reports.export_reports" | "users.create" | "quotes.create" | "quotes.view" | "users.manage_roles" | "files.generate_files" | "files.access_files" | "files.delete_files" | "files.view_files" | "files.cleanup_files" | "allocations.create" | "allocations.read" | "allocations.update" | "allocations.delete" | "allocations.view_capacity" | "approvals.request" | "approvals.decide" | "approvals.view" | "jobs.create_jobs" | "quotes.update" | "quotes.delete" | "quotes.approve" | "quotes.send" | "quotes.override_price" | "rate_cards.view" | "rate_cards.create" | "rate_cards.update" | "rate_cards.delete" | "users.view" | "users.update" | "users.delete" | "customers.view" | "customers.create" | "customers.update" | "customers.delete" | "projects.view" | "projects.create" | "projects.update" | "projects.delete" | "portal.view_own_quotes" | "portal.view_own_invoices" | "portal.view_own_time_entries" | "reports.view_compliance" | "jobs.view_jobs" | "jobs.cancel_jobs" | "jobs.retry_jobs")[];
