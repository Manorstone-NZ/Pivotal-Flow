 ...
 */
export async function registerJobsRoutes(fastify) {
    // Create job
    fastify.post('/v1/jobs', {
        ...
        const jobId = await jobsService.createJob(request.body);
        return {
            jobId,
    ...
    // Get job status
    fastify.get('/v1/jobs/:jobId/status', {
        schema: {
            params: {
                type: 'object',
                properties: {
    ...
    // Cancel job
    fastify.post('/v1/jobs/:jobId/cancel', {
        schema: {
            params: {
                type: 'object',
                properties: {
    ...
    // Retry job
    fastify.post('/v1/jobs/:jobId/retry', {
        schema: {
            params: {
                type: 'object',
                properties: {
