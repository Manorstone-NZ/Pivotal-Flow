import { registerListInvoicesRoute, registerGetInvoiceRoute, registerCreateInvoiceRoute, registerUpdateInvoiceRoute, registerInvoiceStatusRoute, registerMarkInvoicePaidRoute, registerVoidInvoiceRoute, } from './routes.js';
/**
 * Register all invoice routes with Fastify
 */
export function registerInvoiceRoutes(fastify) {
