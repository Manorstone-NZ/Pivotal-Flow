 ...
 * PASETO Links Plugin
 */
export const pasetoLinksPlugin = fp(async (fastify) => {
    ...
    // Helper functions
    fastify.decorate('generateQuoteLink', async (tenantId, quoteId, expiryDays = 30) => {
        return generateQuoteLink(keyManager, tenantId, quoteId, expiryDays);
    });
    fastify.decorate('verifyQuoteLink', async (token) => {
...
//# sourceMappingURL=auth.paseto-links.js.map