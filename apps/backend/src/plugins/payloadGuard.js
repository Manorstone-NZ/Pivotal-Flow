...
export const payloadGuardPlugin = (app, _opts, done) => {
    app.addHook("preHandler", async (req) => {
        const url = req.raw.url || "";
        const isWrite = req.method === "POST" || req.method === "PATCH" || req.method === "PUT";
        const targetsQuotes = url.startsWith("/v1/quotes") || url.startsWith("/v1/quotes/");
        if (!isWrite || !targetsQuotes)
            return;
        const body = req.body || {};
...
//# sourceMappingURL=payloadGuard.js.map