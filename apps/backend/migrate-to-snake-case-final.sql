-- Corrected Migration Script: camelCase to snake_case
-- This script migrates all tables from camelCase to snake_case column naming
...
-- Update foreign key constraint (exact name from database)
...
-- Update unique constraint (exact name from database)
...
-- Update unique constraints (exact names from database)
