 ...
 */
export function applyMultipleDiscounts(originalAmount, discounts) {
 ...
 */
export function validateDiscount(discountType, discountValue, originalAmount) {
    const decimalValue = createDecimal(discountValue);
    // Basic validation
    if (decimalValue.isNegative()) {
        return false;
 ...
 */
export function calculateEffectiveDiscountPercentage(originalAmount, finalAmount) {
 ...
 */
export function wouldResultInNegative(originalAmount, discountType, discountValue) {
    try {
 ...
 */
export function getMaximumSafeDiscount(originalAmount, discountType) {
    switch (discountType) {
        case 'percentage':
