...
describe('Enhanced Quote Calculator', () => {
    ...
    describe('Property Tests', () => {
        ...
        it('should maintain tax consistency', () => {
            ...
            const totalTaxFromLines = result.lineCalculations.reduce((sum, line) => sum.add(line.taxAmount.amount), new Decimal(0));
        ...
        it('should maintain total consistency', () => {
            ...
            const totalFromLines = result.lineCalculations.reduce((sum, line) => sum.add(line.totalAmount.amount), new Decimal(0));
...
describe('JSONB Guard', () => {
    describe('validateMetadataJSONB', () => {
        ...
        it('should reject monetary fields', () => {
            ...
            expect(() => validateMetadataJSONB(invalidMetadata, 'test')).toThrow('JSONB metadata cannot contain business values');
        });
        ...
        it('should provide clear error messages with field paths', () => {
            ...
            expect(() => validateMetadataJSONB(invalidMetadata, 'quote metadata')).toThrow('Field \'subtotal\' at path \'nested.deep.subtotal\' in quote metadata is forbidden');
        });
    });
...
//# sourceMappingURL=enhanced-calculator.test.js.map