 ...
 */
export function calculateQuote(input: CalculateQuoteInput, currencyDecimals: number = 2): QuoteCalculation {
  // Validate input
 ...
 */
export function calculateQuoteDebug(input: CalculateQuoteInput): QuoteDebugOutput {
  // Validate input
  const validatedInput = CalculateQuoteInputSchema.parse(input);
